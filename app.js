    ...
    getData.forEach((element, index) => {
        let createElement = `
            <tr class="medecinDetails">
                ...
                <td>${element.medecinEmail}</td>
                <td>c</td>
                <td>${element.medecinDepartement}</td>
                <td>${element.medecinSpeciality}</td>
                <td>
                    <button class="btn btn-success" onclick="readInfo('${element.picture}', '${element.medecinMatricule}', '${element.medecinEmail}',${element.medecinPhone}, ${element.medecinDepartement},${elment.medecinSpeciality})" data-bs-toggle="modal" data-bs-target="#readData">
                        <i class="bi bi-eye"></i>
                    </button>
                    <button class="btn btn-primary" onclick="editInfo(${index}, '${element.picture}', '${element.medecinMatricule}', '${element.medecinEmail}',${element.medecinPhone}, ${element.medecinDepartement},${elment.medecinSpeciality})" data-bs-toggle="modal" data-bs-target="#userForm">
